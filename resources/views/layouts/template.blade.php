...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-warning elevation-1">
    ...
    <a href="index3.html" class="brand-link bg-warning">
      <img src="{{asset('regform/images/LogoNFT5-removebg.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">NationalFootballTicket</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('admin/dist/img/businessman.png')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
