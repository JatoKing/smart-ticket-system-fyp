...
<!-- Mirrored from keenitsolutions.com/products/html/soccer/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2024 04:34:51 GMT -->
<head>
		<meta charset="utf-8">
		...
		<!-- style css -->
		<link rel="stylesheet" href="{{asset('NationalFootballTicket/style.css')}}">
		<!-- responsive css -->
	...
	<body class="home-two">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="header-top-left">
								{{-- <ul>
									...
									<li><img src="{{asset('NationalFootballTicket/images/logo/flag.jpg')}}" alt="Logo">
                                        <a href="#">English
                                            <i class="fa fa-angle-down" aria-hidden="true"></i>
                                        </a>
										<ul>
                                            <li><img src="{{asset('NationalFootballTicket/images/logo/flag3.jpg')}}" alt="Logo"><a href="#">Malaysia</a></li>
										</ul>
									</li>
								</ul> --}}
							</div>
							...
							<div class="social-media-area">
								<nav>
									<ul>
                                        ...
                                        @else
                                            <li class="log"><a href="{{route('login')}}"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-sm-12 col-xs-12 logo">
                            <a href="index-2.html"><img src="{{asset('regform/images/LogoNFT5-removebg.png')}}" alt="logo"></a>
                        </div>
		...
		<div class="slider-section4 slider-main">
			<div id="slider-five" class="owl-carousel">
				<div class="item active">
					<img src="{{asset('NationalFootballTicket/images/full-slider/bukitjalil.jpeg')}}" alt="Slider image">
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="slider-text text-center">
                                        <h1 data-animation-in="slideInDown" data-animation-out="animate-out slideOutUp">Malaysia<span>VS</span>Indonesia</h1>
                                        ...
                                        <div class="btn-slider">
                                            ...
                                            <a href="{{ route('customer.index') }}" class="btn2" data-animation-in="slideInDown" data-animation-out="animate-out slideOutUp">Book a Ticket</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="slider-text text-center">
                                        <h1 data-animation-in="slideInDown" data-animation-out="animate-out slideOutUp">Malaysia<span>VS</span>Korea Republic</h1>
                    ...
                    <div class="dsc">
					   <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="slider-text text-center">
                                        <h1 data-animation-in="slideInDown" data-animation-out="animate-out slideOutUp">Malaysia<span>VS</span>Iran</h1>
                ...
                <div id="upcoming" class="rs-carousel owl-carousel" data-loop="true" data-items="1" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="1" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="1" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="item">
                        <div class="col-md-4 col-sm-4 col-xs-12 first">
                            <img src="{{asset('NationalFootballTicket/images/upcoming/Malaysia.png')}}" alt="">
                            <h4>Malaysia</h4>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <span>Bukit Jalil Stadium</span>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 last">
                            <img src="{{asset('NationalFootballTicket/images/upcoming/Qatar.png')}}" alt="">
                            <h4>Qatar</h4>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <span class="date">JULY 16, 21:00</span>
                            <span class="vs">VS</span>
                            <span>Bukit Jalil Stadium</span>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-12 last">
                            <img src="{{asset('NationalFootballTicket/images/upcoming/Japan.jpg')}}" alt="">
                            <h4>Japan</h4>
                        </div>
                    </div>
				</div>
                        ...
                        <div class="row">
					        	...
					        	<div class="latest-news-slider">
					        		<div>
										<div class="news-normal-block">
						                    <div class="news-img">
						                    	<a href="#">
						                        	<img src="{{asset('NationalFootballTicket/images/latest/1.jpg')}}" alt="" />
						                    	</a>
						                    </div>
					        		...
					        		<div>
						                <div class="news-normal-block">
						                    <div class="news-img">
						                    	<a href="#">
						                        	<img src="{{asset('NationalFootballTicket/images/latest/2.jpg')}}" alt="" />
						                    	</a>
						                    </div>
					                    	<h4 class="news-title"><a href="blog-single.html">TFC Club Score Seven in CL Rout Match</a></h4>
					                    	<div class="news-desc">
					        		...
					        		<div>
						                <div class="news-normal-block">
						                    <div class="news-img">
						                    	<a href="#">
						                        	<img src="{{asset('NationalFootballTicket/images/latest/3.jpg')}}" alt="" />
						                    	</a>
						                    </div>
					                    	<h4 class="news-title"><a href="blog-single.html">TFC Club Score Seven in CL Rout Match</a></h4>
					                    	<div class="news-desc">
			        		...
			        		<div class="col-sm-3">
					        	<div class="latest-news-nav">
									<div><img src="{{asset('NationalFootballTicket/images/latest/tb1.jpg')}}" alt="" /></div>
									<div><img src="{{asset('NationalFootballTicket/images/latest/tb2.jpg')}}" alt="" /></div>
									<div><img src="{{asset('NationalFootballTicket/images/latest/tb3.jpg')}}" alt="" /></div>
								</div>
			        		</div>
			        	</div>
                    </div>
							...
							<div class="today-match-teams text-center">
								...
								<div class="today-score">
									<div class="today-match-team">
										<img src="{{asset('NationalFootballTicket/images/today-match/1.png')}}" alt="" />
										<h4>Trisal King</h4>
										<span>SKFC</span>
									</div>
									...
									<div class="today-match-team">
										<img src="{{asset('NationalFootballTicket/images/today-match/2.png')}}" alt="" />
										<h4>Mirpur King</h4>
										<span>SWFC</span>
									</div>
								</div>
                                ...
                                <div class="recent-match-results">
                                    <div class="single-result">
                                        <div class="team-result clearfix">
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/1.png')}}">Badda FC</div>
                                            <div class="text-center match-score single-part">
                                                <span class="score">3</span> - <span class="score">2</span>
                                            </div>
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/2.png')}}" alt="Spain">Trisal FC</div>
                                        </div>
                                    </div>
                                    <div class="single-result">
                                        <div class="team-result clearfix">
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/1.png')}}">Banani FC</div>
                                            <div class="text-center match-score single-part">
                                                <span class="score">4</span> - <span class="score">3</span>
                                            </div>
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/2.png')}}" alt="Spain">Mirpur FC</div>
                                        </div>
                                    </div>
                                    <div class="single-result">
                                        <div class="team-result clearfix">
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/1.png')}}">Jpypur FC</div>
                                            <div class="text-center match-score single-part">
                                                <span class="score">2</span> - <span class="score">4</span>
                                            </div>
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/2.png')}}" alt="Spain">Dhoar FC</div>
                                        </div>
                                    </div>
                                    <div class="single-result">
                                        <div class="team-result clearfix">
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/1.png')}}">Trisal FC</div>
                                            <div class="text-center match-score single-part">
                                                <span class="score">6</span> - <span class="score">1</span>
                                            </div>
                                            <div class="text-left match-result-list single-part"><img class="result-img" src="{{asset('NationalFootballTicket/images/today-match/2.png')}}" alt="Spain">Romna FC</div>
                                        </div>
                                    </div>
				...
				<div class="row">
					<div class="col-md-8">
						<div class="video-area mmb-40">
							<img src="{{asset('NationalFootballTicket/images/latest-video/video.jpg')}}" alt="Video"/>
							<div class="videos-icon">
                                <a class="popup-youtube" href="https://www.youtube.com/watch?v=2ITPbaeUKDQ&t=26s">
					...
					<div class="col-md-4 latest-news">
						<div class="inner-news small-news">
							<div class="news-img">
								<a href="blog-single.html"><img src="{{asset('NationalFootballTicket/images/latest-video/1.jpg')}}" alt="News" /></a>
							</div>
							<div class="news-text">
						...
						<div class="inner-news small-news">
							<div class="news-img">
								<a href="blog-single.html"><img src="{{asset('NationalFootballTicket/images/latest-video/2.jpg')}}" alt="News" /></a>
							</div>
							<div class="news-text">
								<h5><a href="blog-single.html">Badda FC vs Banni FC Highlights 1-1</a></h5>
								<span class="date">May 30, 2017</span>
						...
						<div class="inner-news small-news">
							<div class="news-img">
								<a href="blog-single.html"><img src="{{asset('NationalFootballTicket/images/latest-video/3.jpg')}}" alt="News" /></a>
							</div>
							<div class="news-text">
								<h5><a href="blog-single.html">Badda FC vs Banni FC Highlights 1-1</a></h5>
								<span class="date">May 30, 2017</span>
                ...
                <div class="row">
                    <div class="col-md-9 col-sm-8">
                        ...
                        <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="7000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/2.jpg')}}" alt="" />
                            ...
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/3.jpg')}}" alt="" />
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                            ...
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/1.jpg')}}" alt="" />
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                            ...
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/4.jpg')}}" alt="" />
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                            ...
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/5.jpg')}}" alt="" />
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                            ...
                            <div class="our-team">
                                <img src="{{asset('NationalFootballTicket/images/team/6.jpg')}}" alt="" />
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                                <img src="{{asset('NationalFootballTicket/images/gallery2/1.jpg')}}" alt="" />
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                              <img src="{{asset('NationalFootballTicket/images/gallery2/2.jpg')}}" alt="" />
                                <div class="heading-conent">
                                    <h4>Photo Title Here</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                              <img src="{{asset('NationalFootballTicket/images/gallery2/3.jpg')}}" alt="" />
                                <div class="heading-conent">
                                    <h4>Photo Title Here</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                              <img src="{{asset('NationalFootballTicket/images/gallery2/4.jpg')}}" alt="" />
                                <div class="heading-conent">
                                    <h4>Photo Title Here</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                              <img src="{{asset('NationalFootballTicket/images/gallery2/5.jpg')}}" alt="" />
                                <div class="heading-conent">
                                    <h4>Photo Title Here</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="single-gallery">
                              <img src="{{asset('NationalFootballTicket/images/gallery2/6.jpg')}}" alt="" />
                                <div class="heading-conent">
                                    <h4>Photo Title Here</h4>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
			...
			<div class="container">
                ...
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="8000" data-smart-speed="1500" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="4" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="champion-list">
                        <img src="{{asset('NationalFootballTicket/images/awards/1.png')}}" alt="" />
                        <div class="awards-content">
                            <h4 class="awards-title">Club 2017 champion</h4>
                        </div>
                    </div>
                    <div class="champion-list">
                        <img src="{{asset('NationalFootballTicket/images/awards/2.png')}}" alt="" />
                        <div class="awards-content">
                            <h4 class="awards-title">Club 2017 champion</h4>
                        </div>
                    </div>
                    <div class="champion-list">
                        <img src="{{asset('NationalFootballTicket/images/awards/3.png')}}" alt="" />
                        <div class="awards-content">
                            <h4 class="awards-title">Club 2017 champion</h4>
                        </div>
                    </div>
                    <div class="champion-list">
                        <img src="{{asset('NationalFootballTicket/images/awards/4.png')}}" alt="" />
                        <div class="awards-content">
                            <h4 class="awards-title">Club 2017 champion</h4>
                        </div>
                    </div>
                ...
                <div class="rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="4" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="single-product text-center">
                        <div class="product-image">
                            ...
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/product/1.jpg')}}" alt="Product" /></a>
                        </div>
                    ...
                    <div class="single-product text-center">
                        <div class="product-image">
                            <div class="overly"></div>
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/product/2.jpg')}}" alt="Product" /></a>
                        </div>
                        <div class="product-details">
                            <div class="product-tile">
                                <a href="shop-single.html">Product Title Here</a>
                    ...
                    <div class="single-product text-center">
                        <div class="product-image">
                            <div class="overly"></div>
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/product/3.jpg')}}" alt="Product" /></a>
                        </div>
                        <div class="product-details">
                            <div class="product-tile">
                                <a href="shop-single.html">Product Title Here</a>
                    ...
                    <div class="single-product text-center">
                        <div class="product-image">
                            <div class="overly"></div>
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/product/4.jpg')}}" alt="Product" /></a>
                        </div>
                        <div class="product-details">
                            <div class="product-tile">
                                <a href="shop-single.html">Product Title Here</a>
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="testimonial">
                                <div class="testimonial-profile">
                                    <a href="#"><img src="{{asset('NationalFootballTicket/images/testimonial/tom.jpg')}}" alt="tom"></a>
                                </div>
                            ...
                            <div class="testimonial">
                                <div class="testimonial-profile">
                                    <a href="#"><img src="{{asset('NationalFootballTicket/images/testimonial/peter.jpg')}}" alt=""></a>
                                </div>
                                <div class="testimonial-content">
                            ...
                            <div class="testimonial">
                                <div class="testimonial-profile">
                                    <a href="#"><img src="{{asset('NationalFootballTicket/images/testimonial/lan.jpg')}}" alt="Ian"></a>
                                </div>
                                <div class="testimonial-content">
                ...
                <div id="upcoming" class="rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="20" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="4" data-md-device-nav="false" data-md-device-dots="false">
                    <div class="item">
                        <div class="single-logo">
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/logo/1.png')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="single-logo">
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/logo/2.png')}}" alt=""></a>
                        </div>
                    </div>

                    <div class="item">
                        <div class="single-logo">
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/logo/3.png')}}" alt=""></a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="single-logo">
                            <a href="#"><img src="{{asset('NationalFootballTicket/images/logo/4.png')}}" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
		...
		<script src="{{asset('NationalFootballTicket/js/rsmenu-main.js')}}"></script>
		 <!-- jquery-ui js -->
		<script src="{{asset('NationalFootballTicket/s/jquery-ui.min.js')}}"></script>
		<!-- bootstrap js -->
...
<!-- Mirrored from keenitsolutions.com/products/html/soccer/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2024 04:35:27 GMT -->
</html>
